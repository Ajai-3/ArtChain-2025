...
export interface IUploadController {
  ...
  uploadImage(req: Request, res: Response, next: NextFunction): Promise<Response | void>;
  uploadArt(req: Request, res: Response, next: NextFunction): Promise<Response | void>;
  deleteImage(req: Request, res: Response, next: NextFunction): Promise<Response | void>;
}
