...
router.post(
  ...
  transactionController.lockCommissionFunds,
);
router.post(
  ROUTES.TRANSACTION.COMMISSION_DISTRIBUTE,
  transactionController.distributeCommissionFunds,
);
router.post(
...
router.get(
  ROUTES.WITHDRAWAL.GET_REQUESTS,
