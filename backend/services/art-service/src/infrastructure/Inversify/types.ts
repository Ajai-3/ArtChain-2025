export const TYPES = {
  ...
  IDeleteArtPostUseCase: Symbol.for('IDeleteArtPostUseCase'),
  IUpdateArtPostUseCase: Symbol.for('IUpdateArtPostUseCase'),
  IGetAllShopArtsUseCase: Symbol.for('IGetAllShopArtsUseCase'),
  IGetShopArtsByUserUseCase: Symbol.for('IGetShopArtsByUserUseCase'),
  IDeleteUserArtPostUseCase: Symbol.for('IDeleteUserArtPostUseCase'),
