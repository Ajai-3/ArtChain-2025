export const ROUTES = {
  ...
  ART: {
    ...
    COMMISSION_BY_CONVERSATION:
      '/api/v1/art/commission/conversation/:conversationId',
  ...
  WALLET: {
    ...
    ADMIN_WITHDRAWAL_UPDATE_STATUS:
      '/api/v1/wallet/admin/withdrawal/requests/:withdrawalId/status',
