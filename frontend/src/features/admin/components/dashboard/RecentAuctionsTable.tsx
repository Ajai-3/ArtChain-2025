...
> = {
  ...
  unsold: {
    ...
    border: 'border-zinc-400/60 dark:border-zinc-500/50',
...
const RecentAuctionsTable: React.FC<RecentAuctionsTableProps> = ({
  auctions,
}) => {
                  ...
                  {auction.status.toLowerCase() === 'ended' && (
                    <Button
                      ...
                      disabled={
                        ...
                        downloadMutation.variables?.id === auction.id
                      }
