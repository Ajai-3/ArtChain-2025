      ...
      <div className='bg-zinc-900 border border-zinc-800 p-3 rounded-xl shadow-xl backdrop-blur-md'>
        ...
        <div className='space-y-1'>
          <div className='flex justify-between items-center gap-4'>
            ...
            <span className='text-zinc-100 font-mono font-medium text-sm'>
...
const RevenueSourceChart: React.FC<RevenueSourceChartProps> = ({
  revenueBySource,
}) => {
  const pieData = revenueBySource
    ? [
        {
          name: 'Auctions',
          value: revenueBySource.auctions.amount,
          count: revenueBySource.auctions.count,
        },
        {
          name: 'Art Sales',
          value: revenueBySource.artSales.amount,
          count: revenueBySource.artSales.count,
        },
        {
          name: 'Commissions',
          value: revenueBySource.commissions.amount,
          count: revenueBySource.commissions.count,
        },
