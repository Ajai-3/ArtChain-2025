                    ...
                    <div className="flex items-center gap-2">
                        <div className="h-8 w-8 rounded-full bg-muted overflow-hidden">
                           {tx.user?.profileImage ? (
                                <img src={tx.user.profileImage} alt={tx.user.name} className="h-full w-full object-cover" />
                            ) : (
                        ...
                        <div className="flex flex-col">
                            <span className="text-sm font-medium">{tx.user?.name || 'Unknown'}</span>
                            <span className="text-xs text-muted-foreground">@{tx.user?.username || 'unknown'}</span>
                        </div>
                    </div>
                </TableCell>
                <TableCell>
