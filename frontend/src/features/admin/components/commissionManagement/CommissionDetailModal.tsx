                                    ...
                                    <div className="rounded-lg overflow-hidden border border-zinc-800 relative group aspect-video bg-zinc-900">
                                        ...
                                        <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                            <Button
                                                variant="secondary"
                                                size="sm"
                                                onClick={() => window.open(commission.finalArtwork || commission.finalImageUrl, '_blank')}
                                            >
                                                View Full Size
                                            </Button>
                                        </div>
                            ...
                            {commission.status === 'DISPUTE_RAISED' && (
                                <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-4 space-y-3">
                                    ...
                                    <div className="bg-red-500/5 p-3 rounded-lg border border-red-500/10">
                                        <p className="text-xs text-red-300/70 uppercase tracking-wider mb-1 font-bold">Report Reason</p>
                                        <p className="text-sm text-zinc-300 leading-relaxed italic">
                                            "{commission.disputeReason || "No specific reason provided by requester."}"
                                        </p>
                                    </div>
