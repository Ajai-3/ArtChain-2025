...
export default function BiddingListPage() {
  ...
  const {
    ...
    isFetchingNextPage,
    isLoading: loading,
  } = useAuctions(statusFilter, formattedDate, '');
      ...
      <div className='flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-border/40 pb-4'>
        <div>
          ...
          <p className='text-sm text-muted-foreground mt-0.5'>
            Place your bids on exclusive digital art.
          </p>
        </div>
          ...
          {isAuthenticated && (
            <>
              <Button
                variant='outline'
                size='sm'
                onClick={() => navigate('/bidding/my-bids')}
              >
              ...
              <Button
                variant='outline'
                size='sm'
                onClick={() => navigate('/bidding/my-auctions')}
              >
          ...
          <Popover open={isVisiable} onOpenChange={setIsVisiable}>
            <PopoverTrigger asChild>
              <Button
                variant='outline'
                size='sm'
                className='h-9 relative border-dashed'
              >
