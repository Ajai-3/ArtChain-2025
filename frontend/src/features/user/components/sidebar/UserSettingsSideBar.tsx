...
const userSettingsTabs = [
  {
    id: SETTINGS_TABS.PROFILE,
    path: ROUTES.SETTINGS_PROFILE,
    icon: User,
    label: 'Edit Profile',
  },
  {
    id: SETTINGS_TABS.PASSWORD,
    path: ROUTES.SETTINGS_PASSWORD,
    icon: Lock,
    label: 'Password & Security',
  },
  {
    id: SETTINGS_TABS.PURCHASES,
    path: ROUTES.SETTINGS_PURCHASES,
    icon: ShoppingBag,
    label: 'Purchase History',
  },
  {
    id: SETTINGS_TABS.SALES,
    path: ROUTES.SETTINGS_SALES,
    icon: FileText,
    label: 'Sales History',
  },
  {
    id: SETTINGS_TABS.LIKED,
    path: ROUTES.SETTINGS_LIKED,
    icon: Heart,
    label: 'Liked Items',
  },
  {
    id: SETTINGS_TABS.SUPPORT,
