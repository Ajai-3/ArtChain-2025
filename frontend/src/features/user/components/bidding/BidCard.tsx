...
import { ExternalLink, Gavel, Trophy, User, Circle } from 'lucide-react';
    ...
    >
      ...
      <div className='relative w-full h-48 overflow-hidden shrink-0'>
        ...
        <div className='absolute bottom-0 left-0 right-0 px-3 py-2.5 flex items-center gap-2'>
          ...
          <div className='flex flex-col min-w-0'>
            <span className='text-[9px] text-white/40 uppercase tracking-widest leading-none mb-0.5'>
              Host
            </span>
      ...
      <div className='flex flex-col flex-1 p-4 gap-3'>
        ...
        <button
          onClick={(e) => {
            e.stopPropagation();
            navigate(`/bidding/${item.auction.id}`);
          }}
